...
(function(k,e){function n(d){this.rootElement=d;this.expressionName=d.getAttribute("data-expression");this.width=d.getAttribute("data-width");this.height=d.getAttribute("data-height");this.openOnClick=d.getAttribute("data-click");this.openOnClick="open"==this.openOnClick?!0:!1;this.showAvatar=d.getAttribute("data-avatar");this.showAvatar="hide"===this.showAvatar?!1:!0;this.popupPost=this.popupUUID=this.popup=this.urturn=this.cta=this.avatar=this.theater=this.header=null;this.urturnInHeader=!1;this.avatarBG=
"#eae9e8";this.headerBG="#faf9f7";this.theaterBG="#efefef";this.widgetId=1E8*Math.random()|0;this.numberOfColumns=2;this.columnMinWidth=150;this.columns=[];this.columnsSize=[];this.POSTS_MAP={};this.data=null;this.has_more=!1;this.init=function(){if(g){var a=this;urturn.get("post","expression",this.expressionName,this.widgetId,function(b){a.postLoaded(b)})}else urturn.get("post","expression",this.expressionName,this.widgetId,this.postLoaded.bind(this));this.initUI()};this.initUI=function(){this.adaptSize();
this.header=this.createElement("div",{width:"100%",height:"75px",backgroundColor:this.headerBG});this.rootElement.appendChild(this.header);this.theater=this.createElement("div",{width:"100%",height:this.height-75+"px",backgroundColor:this.theaterBG,overflowX:"hidden",overflowY:"auto"});this.rootElement.appendChild(this.theater);this.cta=this.createElement("div",{width:"100%",height:"75px",color:"#000"});this.header.appendChild(this.cta);this.urturnInHeader?(this.urturn=this.createElement("img",{width:"160px",
height:"50px",position:"relative",bottom:this.height-12+"px",left:this.width-160-15+"px",display:"block",cursor:"hand"}),this.urturn.src=h):(this.urturn=this.createElement("img",{width:"500px",height:"50px",position:"relative",bottom:"0px",left:"50%",marginLeft:"-250px",display:"block",cursor:"hand"}),this.style(this.theater,{height:this.height-75-50+"px"}),this.urturn.src=l);this.listen(this.urturn,"click",this.clickUrturn);this.rootElement.appendChild(this.urturn);this.calculateColumns()};this.calculateColumns=
function(){var a=this.width/this.columnMinWidth|0;2>a&&(a=2);this.numberOfColumns=a};this.clickUrturn=function(){k.location="http://"+urturn.getHost()+"/"+this.expressionName+"?#!/documents/new"};this.clickUrturnPopup=function(){k.location="http://"+urturn.getHost()+"/documents/"+this.popupPost.uuid+"?#!/documents/new"};this.adaptSize=function(){this.style(this.rootElement,{padding:"0px",overflow:"hidden"});this.width?this.rootElement.style.width=this.width+"px":(this.rootElement.style.width="100%",
this.width=this.rootElement.offsetWidth);this.height?this.rootElement.style.height=this.height+"px":(this.rootElement.style.height="100%",this.height=this.rootElement.offsetHeight);this.height|=0;this.width|=0;500<=this.width&&(this.urturnInHeader=!0)};this.postLoaded=function(a){this.data=a;this.adaptSize();a.has_more&&(this.has_more=!0);this.setCTA(a.expression.description,a.expression.creator.username,this.cta,!0);this.addPost(a.posts)};this.setCreatorAvatar=function(a){var b=this.createElement("img",
{width:"71px",height:"71px",margin:"2px"});b.src=a;this.avatar.appendChild(b)};this.setCTA=function(a,b,c,d){var f=this.createElement("div",{color:"#000",font:"20px Helvetica",position:"relative",top:"0px",left:"20px",width:this.width-20+"px"});f.innerHTML=d?a+'<br/> <span style="font-size :15px; color : #888">by '+b+"</span>":a;c.appendChild(f);this.style(f,{top:((75-f.offsetHeight)/2|0)+"px"})};this.createPost=function(a){if(this.showAvatar){var b=290;a.thumbnails&&a.thumbnails.thumb_height&&(b=
a.thumbnails.thumb_height*this.columnWidthRatio|0);var c=this.createElement("div",{width:"100%",height:((this.width-17)/this.numberOfColumns|0)+"px",overflow:"hidden"});b<290*this.columnWidthRatio&&this.style(c,{height:b+"px"});b=this.createElement("img",{width:"100%",display:"block"});a.thumbnails&&a.thumbnails.small&&(b.src=a.thumbnails.small);b.setAttribute("data-uuid",a.uuid);c.appendChild(b);b=this.createElement("img",{width:"20px",height:"20px",borderRadius:"50%",border:"2px solid #efefef",
position:"relative",bottom:"30px",left:"10px"});b.src=a.creator.avatar_thumb_url;c.appendChild(b);c.setAttribute("data-uuid",a.uuid);return c}c=this.createElement("img",{width:"100%"});a.thumbnails&&a.thumbnails.small&&(c.src=a.thumbnails.small);c.setAttribute("data-uuid",a.uuid);return c};this.createColumns=function(){var a=0;for(this.columnWidth=(1E4/this.numberOfColumns|0)/100;a<this.numberOfColumns;){var b=this.createElement("div",{width:this.columnWidth+"%"});g?this.style(b,{width:(this.columnWidth*
(this.width-17)/100|0)+"px",position:"absolute",left:(this.columnWidth*(this.width-17)/100*a|0)+"px",top:""}):this.style(b,{"float":"left"});this.columns.push(b);this.columnsSize.push(0);this.theater.appendChild(b);this.columnWidthPx||(this.columnWidthPx=b.offsetWidth,this.columnWidthRatio=b.offsetWidth/290);++a}};this.pushToColumn=function(a,b){for(var c=0,d=this.columnsSize[0],f=1;f<this.columns.length;){var e=this.columnsSize[f];d>e&&(c=f,d=e);++f}this.columns[c].appendChild(a);this.columnsSize[c]=
