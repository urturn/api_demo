...
(a={query:a,queryType:"post",querySelector:"query"});a.id||(a.id=0);if(u(a))return!0;var b=v.get(a);a.page&&b.setPage(a.page);a.perPage&&b.setPageSize(a.perPage);b.next(c,f);return!1};s.getHost=function(){return"urturn.com"};var u=function(a,c,f){return a.query?a.queryType?a.querySelector?"string"!==typeof a.query?(f(d("get","WRONG_FORMAT",{key:"options.query",type:typeof a.query})),!0):"string"!==typeof a.queryType?(f(d("get","WRONG_FORMAT",{key:"options.queryType",type:typeof a.queryType})),!0):
"string"!==typeof a.querySelector?(f(d("get","WRONG_FORMAT",{key:"options.querySelector",type:typeof a.querySelector})),!0):a.page&&"number"!==typeof a.page?(f(d("get","WRONG_FORMAT",{key:"options.page",type:typeof a.page})),!0):a.perPage&&"number"!==typeof a.perPage?(f(d("get","WRONG_FORMAT",{key:"options.perPage",type:typeof a.perPage})),!0):!1:(f(d("get","MISSING_QUERY_SELECTOR",{})),!0):(f(d("get","MISSING_QUERY_TYPE",{})),!0):(f(d("get","MISSING_QUERY",{})),!0)},x=function(a){this.query=a.query;
this.queryType=a.queryType;this.querySelector=a.querySelector;this.page=1;this.perPages=200;this.next=function(a,f){var b="http://urturn.com/api/"+t[this.queryType].name+".json?",b=b+(t[this.queryType].selectors[this.querySelector]+"="+encodeURIComponent(this.query)),b=b+("&page="+this.page++),b=b+("&per_page="+this.perPages);(b=w(b,a,f))&&f(d("get",b,{}))};this.setPage=function(a){a|0&&(this.page=a|0)};this.setPageSize=function(a){this.perPages=a}},w=function(a,c,f){var b=!1;if(n.XMLHttpRequest)b=
