...
width:"100%",height:"100%",backgroundColor:"#000",opacity:"0.8",top:"0px",left:"0px",zIndex:1251}),f&&this.style(this.popupLayer,{position:"absolute",height:100*e.body.clientHeight+"px",width:e.body.clientWidth+"px"}),e.body.appendChild(this.popupLayer),this.listen(this.popupLayer,"click",this.closePopup),this.popup=this.createElement("div",{position:"absolute",top:e.body.scrollTop+20+"px",left:"50%",marginLeft:"-288px",width:"576px",height:(75+1.986*this.popupPost.thumbnails.thumb_height|0)+"px",
