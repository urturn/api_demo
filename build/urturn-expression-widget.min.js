...
this.popup.style.display="none"};this.createPreview=function(){this.currentPost=this.popupUUID;this.popup.innerHTML="";this.popupHeader=this.createElement("div",{width:"100%",height:"75px",backgroundColor:this.headerBG});this.popup.appendChild(this.popupHeader);this.setCTA(this.data.expression.description,this.data.expression.creator.username,this.popupHeader);this.popupUrturn=this.createElement("img",{width:"160px",height:"50px",position:"relative",bottom:"10px",left:"401px",display:"block",cursor:"pointer"});
if(e){var a=this,b=function(b){a.clickUrturnPopup(b)};this.popupUrturn.attachEvent("onclick",b)}else this.popupUrturn.addEventListener("click",this.clickUrturnPopup.bind(this));this.popupUrturn.src=g;this.popupHeader.appendChild(this.popupUrturn);this.popupImg=this.createElement("img",{height:(1.986*this.popupPost.thumbnails.thumb_height|0)+"px",width:"576px"});this.popupImg.src=this.popupPost.thumbnails.small;this.popup.appendChild(this.popupImg);this.popupHDImg=this.createElement("img",{height:(1.986*
this.popupPost.thumbnails.thumb_height|0)+"px",width:"576px"});this.popupHDImg.src=this.popupPost.thumbnails["default"];e?(a=this,b=function(b){a.updatePopupToHD(b)},this.popupHDImg.attachEvent("onload",b)):this.popupHDImg.onload=this.updatePopupToHD.bind(this);!e&&this.popupPost.thumbnails.has_interaction&&(this.popupIframe=this.createElement("iframe",{height:(1.986*this.popupPost.thumbnails.thumb_height+2|0)+"px",width:"577px",position:"relative",left:"0px",top:-(1.986*this.popupPost.thumbnails.thumb_height|
0)+"px",border:"0px",overflow:"hidden"}),this.popupIframe.src="http://"+urturn.getHost()+"/documents/"+this.popupPost.uuid+"/pages/1",this.popup.appendChild(this.popupIframe));this.popupPost.note&&(this.popupNote=this.createElement("div",{width:"100%",height:"75px",backgroundColor:this.headerBG}),b=this.createElement("div",{width:"480px",font:"14px Helvetica",position:"relative",left:"10px",top:"10px"}),b.innerHTML=this.popupPost.note,this.popupNote.appendChild(b),this.popup.appendChild(this.popupNote))};
