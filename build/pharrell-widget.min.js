...
{width:"100%",height:"80px",backgroundColor:"#f93c3a",color:"#fbecd9",position:"absolute",left:"0px",top:(a|0)+74+"px"});a=this.createElement("img",{width:"56px",height:"56px",borderRadius:"32px",position:"absolute",top:"12px",left:"12px"});a.src=this.popupPost.creator.avatar_thumb_url;this.popupNote.appendChild(a);a=this.createElement("div",{width:"480px",font:"14px  'Lato', Arial, Helvetica, sans-serif",position:"absolute",left:"80px",top:"10px",fontWeight:"bold",color:"#fbecd9"});a.innerHTML=this.link(this.popupPost.creator.username,
"//"+urturn.getHost()+"/"+this.popupPost.creator.username,this.ctaColor);this.popupNote.appendChild(a);d=this.createElement("div",{width:"480px",font:"14px  'Lato', Arial, Helvetica, sans-serif",position:"absolute",left:"80px",top:"30px",color:"#fbecd9"});this.popupPost.note?d.innerHTML=120>this.popupPost.note.length?this.parseTags(this.popupPost.note):this.parseTags(this.popupPost.note.substr(0,120))+"...":this.style(a,{top:"32px"});this.popupNote.appendChild(d);this.popup.appendChild(this.popupNote)};
