if(!urturn)var urturn=function(n){var e={},s={post:{name:"posts",selectors:{id:"id",username:"username",expression:"expression_name",query:"q",expressionCreator:"expression_creator"}},expression:{name:"expressions",selectors:{id:"id",username:"username",expression:"expression_name",query:"q"}}};e.get=function(c,h,g){4<=arguments.length?(c={queryType:arguments[0],querySelector:arguments[1],query:arguments[2]},"number"===typeof arguments[3]?(c.id=arguments[3],h=arguments[4],g=arguments[5]):(h=arguments[3],
g=arguments[4])):"string"===typeof c&&(c={query:c,queryType:"post",querySelector:"query"});c.id||(c.id=0);if(t(c))return!0;var b=u.get(c);c.page&&b.setPage(c.page);c.perPage&&b.setPageSize(c.perPage);b.next(h,g);return!1};e.getHost=function(){return"www.urturn.com"};var t=function(c,h,g){return c.query?c.queryType?c.querySelector?"string"!==typeof c.query?(g(l("get","WRONG_FORMAT",{key:"options.query",type:typeof c.query})),!0):"string"!==typeof c.queryType?(g(l("get","WRONG_FORMAT",{key:"options.queryType",
...
p=function(c){this.query=c.query;this.queryType=c.queryType;this.querySelector=c.querySelector;this.page=1;this.perPages=50;this.next=function(c,g){var b="//www.urturn.com/api/"+s[this.queryType].name+".json?",b=b+(s[this.queryType].selectors[this.querySelector]+"="+encodeURIComponent(this.query)),b=b+("&page="+this.page++),b=b+("&per_page="+this.perPages);if("widget"==g){var a=n.location.href;-1!==a.indexOf("?")&&(a=a.substr(0,a.indexOf("?")));b+="&track=1&href="+a}(b=v(b,c,g))&&g(l("get",b,{}))};
this.setPage=function(c){c|0&&(this.page=c|0)};this.setPageSize=function(c){this.perPages=c}},v=function(c,h,g){var b=!1;if(n.XMLHttpRequest)b=new XMLHttpRequest;else if(n.ActiveXObject)try{b=new n.ActiveXObject("Msxml2.XMLHTTP")}catch(a){try{b=new n.ActiveXObject("Microsoft.XMLHTTP")}catch(d){return"XHR_IE_FAIL"}}else return"NO_XHR";b.open("GET",c,!0);b.onreadystatechange=function(a){if(4!=b.readyState)return!1;a=JSON.parse(b.responseText);h(a)};b.send(null)},u=new function(){this._queryHistory=
{};this.get=function(c){var h=c.id+"::"+c.queryType+"::"+c.querySelector+"::"+c.query;if(this._queryHistory[h])return this._queryHistory[h];c=new p(c);return this._queryHistory[h]=c}},l=function(c,h,g){var b={};b.apiMethod="urturn."+c;b.message="An unknow Error happen!";b.code=h;c={MISSING_QUERY:"No query in options hash. We do not know what to search.",MISSING_QUERY_TYPE:"No queryType in options hash. We do not know what to search.",MISSING_QUERY_SELECTOR:"No querySelector in options hash. We do not know what to search.",
WRONG_FORMAT:"{key} should be a String, was a {type} instead!",NO_XHR:"Can not instanciate XMLHttpRequest Object.",XHR_ERROR:"There was an error on urturn server.",XHR_TIMEOUT:"Request to urturn server Timeout.",XHR_IE_FAIL:"No ActiveXObject for XMLHTTP. (ActiveX not activated?)"};if(c[h]){b.message=c[h];for(var a in g)b.message.replace("{"+a+"}",g.key)}return b};"object"!==typeof JSON&&(JSON={});(function(){function c(a){return 10>a?"0"+a:a}function h(d){a.lastIndex=0;return a.test(d)?'"'+d.replace(a,
function(a){var d=m[a];return"string"===typeof d?d:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+d+'"'}function g(a,c){var b,m,e,l,n=d,q,k=c[a];k&&"object"===typeof k&&"function"===typeof k.toJSON&&(k=k.toJSON(a));"function"===typeof f&&(k=f.call(c,a,k));switch(typeof k){case "string":return h(k);case "number":return isFinite(k)?String(k):"null";case "boolean":case "null":return String(k);case "object":if(!k)return"null";d+=r;q=[];if("[object Array]"===Object.prototype.toString.apply(k)){l=
k.length;for(b=0;b<l;b+=1)q[b]=g(b,k)||"null";e=0===q.length?"[]":d?"[\n"+d+q.join(",\n"+d)+"\n"+n+"]":"["+q.join(",")+"]";d=n;return e}if(f&&"object"===typeof f)for(l=f.length,b=0;b<l;b+=1)"string"===typeof f[b]&&(m=f[b],(e=g(m,k))&&q.push(h(m)+(d?": ":":")+e));else for(m in k)Object.prototype.hasOwnProperty.call(k,m)&&(e=g(m,k))&&q.push(h(m)+(d?": ":":")+e);e=0===q.length?"{}":d?"{\n"+d+q.join(",\n"+d)+"\n"+n+"}":"{"+q.join(",")+"}";d=n;return e}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=
...
d,r,m={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},f;"function"!==typeof JSON.stringify&&(JSON.stringify=function(a,b,c){var m;r=d="";if("number"===typeof c)for(m=0;m<c;m+=1)r+=" ";else"string"===typeof c&&(r=c);if((f=b)&&"function"!==typeof b&&("object"!==typeof b||"number"!==typeof b.length))throw Error("JSON.stringify");return g("",{"":a})});"function"!==typeof JSON.parse&&(JSON.parse=function(a,d){function r(a,b){var c,m,f=a[b];if(f&&"object"===typeof f)for(c in f)Object.prototype.hasOwnProperty.call(f,
c)&&(m=r(f,c),void 0!==m?f[c]=m:delete f[c]);return d.call(a,b,f)}var c;a=String(a);b.lastIndex=0;b.test(a)&&(a=a.replace(b,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,"")))return c=eval("("+a+")"),"function"===typeof d?r({"":c},""):c;throw new SyntaxError("JSON.parse");})})();return e}(window);(function(n,e){function s(b){this.rootElement=b;this.expressionName=b.getAttribute("data-expression");this.width=b.getAttribute("data-width");this.height=b.getAttribute("data-height");this.availableWidth=n.innerWidth||e.documentElement.clientWidth||e.getElementsByTagName("body")[0].clientWidth;this.openOnClick=b.getAttribute("data-click");this.openOnClick="open"==this.openOnClick?!0:!1;this.showAvatar=b.getAttribute("data-avatar");this.showAvatar="show"===this.showAvatar?!0:!1;this.popupPost=this.popupUUID=
this.popup=this.urturn=this.cta=this.avatar=this.theater=this.header=null;this.urturnInHeader=!1;this.avatarBG="#eae9e8";this.headerBG="#faf9f7";b.getAttribute("data-header-color")&&(this.headerBG=b.getAttribute("data-header-color"));this.urturnBG="#d2523e";b.getAttribute("data-urturn-color")&&(this.urturnBG=b.getAttribute("data-urturn-color"));this.ctaColor="#000";b.getAttribute("data-text-color")&&(this.ctaColor=b.getAttribute("data-text-color"));this.ctaAuthorColor=this.ctaColor;this.widgetId=
1E8*Math.random()|0;this.numberOfColumns=2;this.columnMinWidth=150;this.columns=[];this.columnsSize=[];this.POSTS_MAP={};this.POSTS_INDEX=[];this.data=null;this.has_more=!1;this.init=function(){urturn.get("post","expressionCreator","pepsi",this.widgetId,this.bindfn(this,this.postLoaded),"widget");this.initUI()};this.initUI=function(){this.adaptSize();this.header=this.createElement("div",{width:"100%",height:"75px",backgroundColor:this.headerBG});this.rootElement.appendChild(this.header);this.theater=
...
this.height?this.rootElement.style.height=this.height+"px":(this.rootElement.style.height="100%",this.height=this.rootElement.offsetHeight);this.height|=0;this.width|=0;500<=this.width&&(this.urturnInHeader=!0)};this.postLoaded=function(a){this.data=a;this.adaptSize();a.has_more&&(this.has_more=!0);this.setCTA("JOIN THE #FUTBOLNOW ART MOVEMENT","Pepsi",this.cta,!0);6>a.posts.length&&500>this.width?this.numberOfColumns=1:this.createColumns();this.addPost(a.posts)};this.moreLoaded=function(a){a.has_more&&
(this.has_more=!0);this.addPost(a.posts)};this.setCreatorAvatar=function(a){var d=this.createElement("img",{width:"71px",height:"71px",margin:"2px"});d.src=a;this.avatar.appendChild(d)};this.setCTA=function(a,d,b,c,f){var e=this.createElement("div",{color:this.ctaColor,font:"22px Helvetica",position:"relative",top:"0px",left:"12px",width:this.width-20+"px"});!f&&30<a.length&&this.style(e,{font:"15px Helvetica"});500<=this.width&&this.style(e,{width:this.width-40-160+"px"});f&&this.style(e,{width:"400px"});
e.innerHTML=c?a+'<br/> <span style="font-size :14px; color : '+this.ctaAuthorColor+'">by '+d+"</span>":a;b.appendChild(e);this.style(e,{top:((75-e.offsetHeight)/2|0)+"px"});return e};this.createPost=function(a){if(this.showAvatar){var d=290;a.thumbnails&&a.thumbnails.thumb_height&&(d=a.thumbnails.thumb_height*this.columnWidthRatio|0);var b=this.createElement("div",{width:"100%",height:((this.width-17)/this.numberOfColumns|0)+"px",overflow:"hidden"});d<290*this.columnWidthRatio&&this.style(b,{height:d+
"px"});d=this.createElement("img",{width:"100%",display:"block"});a.thumbnails&&a.thumbnails.small&&(d.src=a.thumbnails.small);d.setAttribute("data-uuid",a.uuid);b.appendChild(d);d=this.createElement("img",{width:"20px",height:"20px",borderRadius:"50%",border:"2px solid #efefef",position:"relative",bottom:"30px",left:"10px"});d.src=a.creator.avatar_thumb_url;b.appendChild(d);b.setAttribute("data-uuid",a.uuid);return b}b=this.createElement("img",{width:"100%",display:"block",minHeight:this.columnWidth+
"px"});a.thumbnails&&a.thumbnails.small&&(b.src=a.thumbnails.small);b.setAttribute("data-uuid",a.uuid);return b};this.createColumns=function(){var a=0;for(this.columnWidth=(1E4/this.numberOfColumns|0)/100;a<this.numberOfColumns;){var d=this.createElement("div",{width:this.columnWidth+"%"});p?this.style(d,{width:(this.columnWidth*(this.width-17)/100|0)+"px",position:"absolute",left:(this.columnWidth*(this.width-17)/100*a|0)+"px",top:""}):this.style(d,{"float":"left"});this.columns.push(d);this.columnsSize.push(0);
this.theater.appendChild(d);this.columnWidthPx||(this.columnWidthPx=d.offsetWidth,this.columnWidthRatio=d.offsetWidth/290);++a}};this.pushToColumn=function(a,d){for(var b=0,c=this.columnsSize[0],f=1;f<this.columns.length;){var e=this.columnsSize[f];c>e&&(b=f,c=e);++f}this.columns[b].appendChild(a);this.columnsSize[b]=d.thumbnails&&d.thumbnails.thumb_height?290>d.thumbnails.thumb_height?this.columnsSize[b]+d.thumbnails.thumb_height:this.columnsSize[b]+290:this.columnsSize[b]+290};this.addPost=function(a){for(var d=
0;d<a.length;){a[d].uuid&&(this.POSTS_MAP[a[d].uuid]=a[d],this.POSTS_INDEX.push(a[d].uuid));var b=this.createPost(a[d]);if(b){if(this.openOnClick)if(u){var c=this.createElement("a",{width:"100%",height:(this.width/this.numberOfColumns|0)+"px",overflow:"hidden",display:"block"});c.href="//"+urturn.getHost()+"/documents/"+a[d].uuid;c.target="_blank";c.appendChild(b);b=c}else this.listen(b,"click",this.open);1===this.numberOfColumns?this.theater.appendChild(b):this.pushToColumn(b,a[d])}++d}};this.createView=
function(){var a=this.popupPost.thumbnails.thumb_height;if(!a||10>a)a=576;if(this.popup)this.popupLayer.style.display="block",this.popup.style.display="block",this.rightArrow.style.display="block",this.leftArrow.style.display="block";else{this.popupLayer=this.createElement("div",{position:"fixed",width:"100%",height:"100%",backgroundColor:"#000",opacity:"0.8",top:"0px",left:"0px",zIndex:1251});p&&this.style(this.popupLayer,{position:"absolute",height:100*e.body.clientHeight+"px",width:e.body.clientWidth+
"px"});e.body.appendChild(this.popupLayer);this.listen(this.popupLayer,"click",this.closePopup);this.popupWidth=600;this.popupHeight=95+(a|0);this.viewHeight=a;this.viewWidth=576;if(700>this.availableWidth){alert(this.availableWidth);this.popupWidth=this.availableWidth-60;var d=(this.popupWidth-24)/600;this.viewHeight=a*d|0;this.popupHeight=95+(this.viewHeight|0)|0;this.viewWidth=576*d|0}d=e.body.scrollTop;0==d&&0!==n.pageYOffset&&(d=n.pageYOffset);this.popup=this.createElement("div",{position:"absolute",
top:d+20+"px",left:"50%",marginLeft:"-"+(this.popupWidth/2|0)+"px",width:this.popupWidth+"px",height:this.popupHeight+"px",backgroundColor:"#faf7f7",zIndex:1255});this.popup.innerHTML="";e.body.appendChild(this.popup);this.leftArrow=this.createElement("div",{position:"absolute",top:"50%",left:"50%",marginLeft:-((this.popupWidth/2|0)+58)+"px",width:"50px",height:"50px",zIndex:1255,backgroundImage:'url("'+h+'")'});this.rightArrow=this.createElement("div",{position:"absolute",top:"50%",left:"50%",marginLeft:(this.popupWidth/
2|0)+8+"px",width:"50px",height:"50px",zIndex:1255,backgroundImage:'url("'+g+'")'});e.body.appendChild(this.leftArrow);e.body.appendChild(this.rightArrow);this.listen(this.leftArrow,"click",this.goLeft);this.listen(this.rightArrow,"click",this.goRight)}this.style(this.popup,{top:e.body.scrollTop+20+"px",height:95+(a|0)+"px"});this.style(this.rightArrow,{top:e.body.scrollTop+20+37+(a/2|0)+"px"});this.style(this.leftArrow,{top:e.body.scrollTop+20+37+(a/2|0)+"px"})};this.closePopup=function(){this.popupLayer.style.display=
"none";this.popup.style.display="none";this.rightArrow.style.display="none";this.leftArrow.style.display="none"};this.goLeft=function(){var a=this.inIndex(this.currentPost);a--;0>a&&(a=this.POSTS_INDEX.length-1);this.popupUUID=this.POSTS_INDEX[a];this.openPostFromUUID()};this.goRight=function(){var a=this.inIndex(this.currentPost);a++;a>=this.POSTS_INDEX.length&&(a=0);this.popupUUID=this.POSTS_INDEX[a];this.openPostFromUUID()};this.inIndex=function(a){for(var d=0;d<this.POSTS_INDEX.length;){if(this.POSTS_INDEX[d]===
a)return d;++d}return 0};this.createPreview=function(){this.currentPost=this.popupUUID;this.popup.innerHTML="";this.popupHeader=this.createElement("div",{width:"100%",height:"74px",backgroundColor:"#faf7f7",color:"#565050"});this.popup.appendChild(this.popupHeader);this.style(this.setCTA("JOIN THE #FUTBOLNOW ART MOVEMENT","pepsi",this.popupHeader,!1,"fullSize"),{color:"#565050"});this.popupUrturn=this.createElement("a",{width:"160px",height:"50px",position:"absolute",top:"12px",right:"12px",display:"block",
borderRadius:"8px"});this.popupUrturn.href="//pepsi.urturn.com";this.urturn.target="_blank";var a=this.createElement("img",{width:"160px",height:"50px",position:"absolute",top:"0px",left:"0px",display:"block",border:"none"});a.src=l;this.popupUrturn.appendChild(a);this.popupHeader.appendChild(this.popupUrturn);a=this.popupPost.thumbnails.thumb_height;if(!a||10>a)a=this.viewHeight;this.popupWidth=600;this.popupHeight=95+(a|0);this.viewHeight=a;this.viewWidth=576;if(700>this.availableWidth){alert(this.availableWidth);
...
this.popupHDImg.src=this.popupPost.thumbnails["default"];if(p){var b=this;this.popupHDImg.attachEvent("onload",function(a){b.updatePopupToHD(a)})}else this.popupHDImg.onload=this.updatePopupToHD.bind(this);p||u||v||!this.popupPost.thumbnails.has_interaction||(b=this,this.popupIframe=this.createElement("iframe",{height:(this.viewHeight|0)+"px",width:(this.viewWidth|0)+"px",position:"relative",left:"12px",top:"-10000000px",border:"0px",overflow:"hidden",visibility:"visible"}),this.startTime=(new Date).getTime(),
...
{width:"100%",height:"80px",backgroundColor:"#faf7f7",color:"#424242",position:"absolute",left:"0px",top:(a|0)+74+"px"});a=this.createElement("img",{width:"56px",height:"56px",borderRadius:"32px",position:"absolute",top:"12px",left:"12px"});a.src=this.popupPost.creator.avatar_thumb_url;this.popupNote.appendChild(a);a=this.createElement("div",{width:"480px",font:"14px Helvetica",position:"absolute",left:"80px",top:"10px",fontWeight:"bold",color:"#565050"});a.innerHTML=this.link(this.popupPost.creator.username,
...
8>=new Number(RegExp.$1)&&(l="//"+urturn.getHost()+"/widget/turnit.png",c="//"+urturn.getHost()+"/widget/bottom_btn.png",h="//"+urturn.getHost()+"/widget/arrow_left.png",g="//"+urturn.getHost()+"/widget/arrow_right.png");t()})(window,document);
